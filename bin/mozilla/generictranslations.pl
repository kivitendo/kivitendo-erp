...
sub edit_email_strings {
  ...
  my %placeholder_specs = (
    ...
    preset_text_invoice              => SL::DB::Invoice->new()->email_replacement_specs()->{options},
    preset_text_invoice_direct_debit => SL::DB::Invoice->new()->email_replacement_specs()->{options},
