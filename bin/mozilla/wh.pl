...
sub generate_journal {
  ...
  my %filter;
  my @columns = qw(ids trans_id date warehouse_from bin_from warehouse_to bin_to partnumber type_and_classific partdescription chargenumber bestbefore  comment transfer direction qty trans_type partunit employee oe_id projectnumber);
