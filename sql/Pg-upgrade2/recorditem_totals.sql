...
ALTER TABLE orderitems ADD COLUMN taxkey_id integer;
...
ALTER TABLE delivery_order_items ADD COLUMN taxkey_id integer;
...
ALTER TABLE invoice ADD COLUMN taxkey_id integer;
...
ALTER TABLE reclamation_items ADD COLUMN taxkey_id integer;
