-- @tag: file_storage_storno_invoice
-- @description: Dateispeicher auch für Stornorechnungen
-- @depends: file_storage_purchase_order_confirmation file_object_type_storno_invoice_as_enum
-- @ignore: 0
