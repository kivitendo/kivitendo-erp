...
\newcommand{\lieferzeit} {Voraussichtliche Lieferzeit:}
...
\newcommand{\kostenvoranschlag} {Kostenvoranschlag}
...
\newcommand{\vorkasserechnung} {Vorkasse-Rechnung}
\newcommand{\nurort} {Ort}
\newcommand{\den} {den}
...
\newcommand{\abrechnungszeitraum} {Abr.-Zeitraum}
