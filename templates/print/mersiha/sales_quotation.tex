...
<%if template_meta.formname == "sales_estimate"%>
  \renewcommand{\angebot}{\kostenvoranschlag}
<%end%>
...
\setkomavar{title}{\angebot~<%quonumber%>}
...
\begin{letter}{
  ...
  <%if lead_time%>
    \lieferzeit ~<%lead_time.description_long%>\\
  <%end%>
