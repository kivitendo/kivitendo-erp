...
<%if template_meta.formname == "payment_in_advance"%>
  \renewcommand{\proformarechnung}{\vorkassenrechnung}
<%end%>
...
\setkomavar{info7}[\ansprechpartner]   {<%employee_name%>}
\setkomavar{info8}[\textTelefon]       {<%employee_tel%>}
\setkomavar{info9}[\textEmail]         {<%employee_email%>}
\setkomavar{fromname}                  {<%employee_name%>}

\setkomavar{title}{\proformarechnung~\nr~<%ordnumber%>}
