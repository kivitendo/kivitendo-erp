...
\newcommand{\lieferzeit} {Anticipated lead time:}
...
\newcommand{\kostenvoranschlag} {Estimate of Cost}
...
\newcommand{\vorkasserechnung} {Prepayment Invoice}
\newcommand{\nurort} {Place}
\newcommand{\den} {Date}
...
\newcommand{\abrechnungszeitraum} {Invoicing Period}
...
%lagerliste/bin_list
\newcommand*{\lagerliste}{Bin List}
\newcommand*{\lieferanschrift}{Lieferanschrift}
\newcommand*{\bestellnummer}{Bestellnummer}
\newcommand*{\kontakt}{Contact}
\newcommand*{\lager}{Warehouse}
\newcommand*{\lagerplatz}{Bin}
\newcommand*{\lieferungMit}{Ship Via}
\newcommand*{\nummer}{Number}
\newcommand*{\beschreibung}{Description}
\newcommand*{\erh}{Got}

%sammelliste
\newcommand*{\sammelliste}{Pick List}
