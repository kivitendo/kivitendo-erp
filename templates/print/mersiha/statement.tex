...
\setkomavar{info1}[\kundennummer]   {<%customernumber%>}
\setkomavar{info2}[\ansprechpartner]{<%employee_name%>}
\setkomavar{info3}[\textTelefon]    {<%employee_tel%>}
\setkomavar{info4}[\textEmail]      {<%employee_email%>}
\setkomavar{fromname}               {<%employee_name%>}

\setkomavar{title}{\sammelrechnung~\nr~<%quonumber%>}
