...
sub read_user {
  ...
  # The 'kivitendo.css', 'lx-office-erp.css' and 'Win2000.css' stylesheets have been removed.
  $user_data{stylesheet} = 'design40.css' if ($user_data{stylesheet} || '') =~ m/win2000|kivitendo\.css|lx-office-erp\.css/i;
