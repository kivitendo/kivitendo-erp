...
__PACKAGE__->meta->columns(
  ...
  email_paragraph_style_body                  => { type => 'text', default => '', not_null => 1 },
  email_paragraph_style_company_signature     => { type => 'text', default => '', not_null => 1 },
  email_paragraph_style_employee_signature    => { type => 'text', default => '', not_null => 1 },
  ...
  zugferd_attach_linked_sales_delivery_orders => { type => 'enum', check_in => [ 'no', 'only_if_exists', 'yes', 'create_always' ], db_type => 'zugferd_attach_linked_sales_delivery_orders_type', default => 'no', not_null => 1 },
);
