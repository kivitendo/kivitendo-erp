...
my %type_data = (
  AP_TRANSACTION_TYPE() => {
    text => {
      ...
      posted       => t8("The ap transaction has been posted"),
  ...
  AP_TRANSACTION_STORNO_TYPE() => {
    text => {
      ...
      posted       => t8("The storno ap transaction has been posted"),
  ...
  PURCHASE_INVOICE_TYPE() => {
    text => {
      ...
      posted       => t8("The purchase invoice has been posted"),
  ...
  PURCHASE_INVOICE_STORNO_TYPE() => {
    text => {
      ...
      posted       => t8("The storno purchase invoice has been posted"),
  ...
  PURCHASE_CREDIT_NOTE_TYPE() => {
    text => {
      ...
      posted       => t8("The purchase credit note has been posted"),
  ...
  PURCHASE_CREDIT_NOTE_STORNO_TYPE() => {
    text => {
      ...
      posted       => t8("The storno purchase credit note has been posted"),
